'object' == typeof navigator &&
  (function (e, t) {
      ...
      te = t(function (e) {
        ...
        (e.exports = function (e, t, o, a) {
          var s,
            ...
            u = !!a && !!a.noTargetGet;
          'function' == typeof o &&
            ('string' != typeof t || b(o, 'name') || O(o, 'name', t),
            (s = n(o)).source ||
    ...
    var Ve =
      ...
      $e = {
        f: function (e) {
          return Ke && '[object Window]' == We.call(e)
            ? (function (e) {
                try {
                  return ze(e);
                } catch (e) {
      ...
      Qe = function (e) {
        return (
          b(Ye, e) ||
            (je && b(Ge, e) ? (Ye[e] = Ge[e]) : (Ye[e] = Xe('Symbol.' + e))),
          Ye[e]
        );
      },
      Je = { f: Qe },
      ...
      et = function (e) {
        ...
        b(t, e) || Ze(t, e, { value: Je.f(e) });
      },
      tt = x.f,
      nt = Qe('toStringTag'),
      it = function (e, t, n) {
        e &&
          !b((e = n ? e : e.prototype), nt) &&
      ...
      jt = function (e, t) {
        ...
        return (
          mt(n, { type: dt, tag: e, description: t }),
          o || (n.description = t),
          n
        );
      },
      ...
      Rt = function (e, t, n) {
        ...
        return (
          ...
          b(Et, i)
            ? (n.enumerable
                ? (b(e, ft) && e[ft][i] && (e[ft][i] = !1),
                  (n = Ve(n, { enumerable: c(0, !1) })))
                : (b(e, ft) || kt(e, ft, c(1, {})), (e[ft][i] = !0)),
              Lt(e, i, n))
            : kt(e, i, n)
        );
      },
      ...
      _t = function (e) {
        var t = v(e, !0),
          n = St.call(this, t);
        return (
          !(this === vt && b(Et, t) && !b(At, t)) &&
          (!(n || !b(this, t) || !b(Et, t) || (b(this, ft) && this[ft][t])) ||
            n)
        );
      },
      Ut = function (e, t) {
        ...
        if (n !== vt || !b(Et, i) || b(At, i)) {
          var r = wt(n, i);
          return (
            !r || !b(Et, i) || (b(n, ft) && n[ft][i]) || (r.enumerable = !0), r
          );
        }
      },
      Dt = function (e) {
    ...
    if (
      (je ||
        (te(
          (yt = function () {
            ...
            return o && It && Lt(vt, t, { configurable: !0, set: n }), jt(t, e);
          }).prototype,
          'toString',
          function () {
            return gt(this).tag;
        ...
        o &&
          (kt(yt.prototype, 'description', {
            configurable: !0,
            get: function () {
              return gt(this).description;
            },
          }),
          te(vt, 'propertyIsEnumerable', _t, { unsafe: !0 }))),
      Le({ global: !0, wrap: !0, forced: !je, sham: !je }, { Symbol: yt }),
      ht(_e(xt), function (e) {
        et(e);
      }),
      Le(
        { target: dt, stat: !0, forced: !je },
        {
          for: function (e) {
            var t = String(e);
      ...
      Le(
        { target: 'Object', stat: !0, forced: !je, sham: !o },
        {
          create: function (e, t) {
      ...
      var qt =
        ...
        r(function () {
          var e = yt();
          return (
            '[null]' != bt([e]) || '{}' != bt({ a: e }) || '{}' != bt(Object(e))
          );
        });
      Le(
        { target: 'JSON', stat: !0, forced: qt },
        {
          stringify: function (e, t, n) {
            for (var i, r = [e], o = 1; arguments.length > o; )
              r.push(arguments[o++]);
            if (((i = t), (g(t) || void 0 !== e) && !Nt(e)))
              return (
                Re(t) ||
                  (t = function (e, t) {
                    if (
    ...
    if (
      o &&
      'function' == typeof Bt &&
      (!('description' in Bt.prototype) || void 0 !== Bt().description)
    ) {
      var Vt = {},
        zt = function () {
          var e =
      ...
      Ht(Wt, 'description', {
        ...
        Le({ global: !0, forced: !0 }, { Symbol: zt });
    }
    et('iterator');
    var Gt = function (e, t) {
        var n = [][e];
      ...
      Zt = function (e, t) {
        ...
        return (Qt[e] =
          ...
          !r(function () {
            if (i && !o) return !0;
            var e = { length: -1 };
            i ? Xt(e, 1, { enumerable: !0, get: Jt }) : (e[1] = 1),
              n.call(e, a, s);
          }));
      },
      en = ut.forEach,
    ...
    Le(
      { target: 'Array', proto: !0, forced: [].forEach != rn },
      { forEach: rn }
    );
    var on = pe.indexOf,
      an = [].indexOf,
      ...
      ln = Gt('indexOf'),
      cn = Zt('indexOf', { ACCESSORS: !0, 1: 0 });
    Le(
      { target: 'Array', proto: !0, forced: sn || !ln || !cn },
      {
        indexOf: function (e) {
          return sn
            ? an.apply(this, arguments) || 0
            : on(this, e, arguments.length > 1 ? arguments[1] : void 0);
        },
      }
    );
    var un = Qe('unscopables'),
      hn = Array.prototype;
    null == hn[un] && x.f(hn, un, { configurable: !0, value: Ve(null) });
    var fn,
      dn,
      pn,
      mn = function (e) {
    ...
    [].keys &&
      ('next' in (pn = [].keys())
        ? (dn = wn(wn(pn))) !== Object.prototype && (fn = dn)
        : (Tn = !0)),
      null == fn && (fn = {}),
      b(fn, kn) ||
        O(fn, kn, function () {
    ...
    var Sn = { IteratorPrototype: fn, BUGGY_SAFARI_ITERATORS: Tn },
        ...
        if (
          (g &&
            ...
            xn !== Object.prototype &&
              s.next &&
              (wn(s) !== xn &&
                (Pn ? Pn(s, xn) : 'function' != typeof s[In] && O(s, In, Rn)),
              it(s, h, !0))),
          r == jn &&
            p &&
            p.name !== jn &&
          ...
          if (((l = { values: u(jn), keys: o ? m : u(Ln), entries: u(Nn) }), a))
            for (c in l) (On || f || !(c in d)) && te(d, c, l[c]);
          else Le({ target: t, proto: !0, forced: On || f }, l);
        return l;
      },
      _n = 'Array Iterator',
      Un = ee.set,
      ...
      Fn = Mn(
        ...
        'Array',
        function (e, t) {
          Un(this, { type: _n, target: m(e), index: 0, kind: t });
        },
        function () {
          var e = Dn(this),
            t = e.target,
    ...
    var qn = [].join,
      ...
      Bn = Gt('join', ',');
    Le(
      { target: 'Array', proto: !0, forced: Hn || !Bn },
      {
        join: function (e) {
    ...
    var Vn,
      ...
      Gn = Yn && Yn.v8;
    Gn
      ? (zn = (Vn = Gn.split('.'))[0] + Vn[1])
      : Kn &&
        (!(Vn = Kn.match(/Edge\/(\d+)/)) || Vn[1] >= 74) &&
        (Vn = Kn.match(/Chrome\/(\d+)/)) &&
        (zn = Vn[1]);
    var Xn = zn && +zn,
      Qn = Qe('species'),
      Jn = function (e) {
      ...
      Zn = Jn('slice'),
      ei = Zt('slice', { ACCESSORS: !0, 0: 0, 1: 2 }),
      ti = Qe('species'),
      ni = [].slice,
      ii = Math.max;
    Le(
      { target: 'Array', proto: !0, forced: !Zn || !ei },
      {
        slice: function (e, t) {
          var n,
            i,
          ...
          if (
            ...
            (n !== Array && !Re(n.prototype))
              ? g(n) && null === (n = n[ti]) && (n = void 0)
              : (n = void 0),
            n === Array || void 0 === n)
          )
            return ni.call(o, s, l);
          for (
            i = new (void 0 === n ? Array : n)(ii(l - s, 0)), r = 0;
            s < l;
            s++, r++
          )
            s in o && Wn(i, r, o[s]);
    ...
    oi || te(Object.prototype, 'toString', ci, { unsafe: !0 });
    var ui = function () {
      var e = C(this),
        t = '';
      return (
        ...
        return (
          ...
          a
            ? i
              ...
              : (o.lastIndex = 0)
            : gi && i && (o.lastIndex = o.global ? i.index + i[0].length : t),
          yi &&
            i &&
            i.length > 1 &&
    ...
    var bi = mi;
    Le({ target: 'RegExp', proto: !0, forced: /./.exec !== bi }, { exec: bi });
    var wi = 'toString',
      ki = RegExp.prototype,
      Ti = ki.toString,
      Si = r(function () {
      ...
      te(
        ...
        function () {
          ...
          return (
            ...
            '/' +
            String(
              void 0 === n && e instanceof RegExp && !('flags' in ki)
                ? ui.call(e)
                : n
            )
          );
    ...
    Mn(
      ...
      'String',
      function (e) {
        Oi(this, { type: xi, string: String(e), index: 0 });
      },
      function () {
        var e,
          t = Ii(this),
        ...
        return i >= n.length
          ? { value: void 0, done: !0 }
          : ((e = Pi(n, i)), (t.index += e.length), { value: e, done: !1 });
      }
    );
    var Li = Qe('species'),
      ji = !r(function () {
    ...
    Ui('search', 1, function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          var s = qi(r, o);
          return (
            Ki(r.lastIndex, a) || (r.lastIndex = a), null === s ? -1 : s.index
          );
        },
      ];
    });
          ...
          [
            ...
            function (e, r) {
              ...
              for (var d = 0, p = 0, m = []; p < s.length; ) {
                ...
                if (
                  null === v ||
                  (g = Ji(ce(h.lastIndex + (er ? 0 : p)), s.length)) === d
                )
                  p = Fi(s, p, c);
                else {
    ...
    var fr = Qe('iterator'),
      ...
      vr =
        ...
        r(function () {
              ...
              mr(
                ...
                mr(
                  gr({}, 'a', {
                    enumerable: !0,
                    get: function () {
                      gr(this, 'b', { value: 3, enumerable: !1 });
                    },
                  }),
                  { b: 2 }
                )
          ...
          ? function (e, t) {
              for (
                var n = Me(e), i = arguments.length, r = 1, a = we.f, s = l.f;
                i > r;
      ...
      Ar = function (e) {
        var t,
          ...
          d = 0;
        if (
          (h && (u = ot(u, c > 2 ? arguments[2] : void 0, 2)),
          null == f || (l == Array && Tr(f)))
        )
      ...
      eo = function (e, t) {
        if (t)
          for (var n, i, r = t.split('&'), o = 0; o < r.length; )
            (n = r[o++]).length &&
              ((i = n.split('=')),
              e.push({ key: Gr(i.shift()), value: Gr(i.join('=')) }));
      },
      to = function (e) {
      ...
      io = Cn(
        function (e, t) {
          Br(this, { type: Hr, iterator: _r(Vr(e).entries), kind: t });
        },
        'Iterator',
        function () {
          var e = zr(this),
          ...
          if (g(c))
            if ('function' == typeof (e = Er(c)))
              for (n = (t = e.call(c)).next; !(i = n.call(t)).done; ) {
                if (
                  (a = (o = (r = _r(C(i.value))).next).call(r)).done ||
                  (s = o.call(r)).done ||
                  !o.call(r).done
                )
    ...
    Mr(
      oo,
      {
        ...
        delete: function (e) {
          ...
          for (
            var t = Vr(this), n = t.entries, i = e + '', r = 0;
            r < n.length;
        ...
        getAll: function (e) {
          no(arguments.length, 1);
          for (
            var t = Vr(this).entries, n = e + '', i = [], r = 0;
            r < t.length;
            r++
          )
        ...
        forEach: function (e) {
          for (
            var t,
              n = Vr(this).entries,
              i = ot(e, arguments.length > 1 ? arguments[1] : void 0, 3),
              r = 0;
            r < n.length;
      ...
      it(ro, qr),
      Le({ global: !0, forced: !dr }, { URLSearchParams: ro }),
      dr ||
        'function' != typeof Ur ||
        'function' != typeof Dr ||
        Le(
              ...
              return (
                arguments.length > 1 &&
                  (g((t = arguments[1])) &&
                    ((n = t.body),
                    li(n) === qr &&
                      ((i = t.headers ? new Dr(t.headers) : new Dr()).has(
                        'content-type'
                      ) ||
                        i.set(
                          'content-type',
    ...
    var ao,
      so = { URLSearchParams: ro, getState: Vr },
      lo = Ci.codeAt,
      co = i.URL,
      ...
      jo = function (e) {
        ...
        for (n = [], i = 0; i < t; i++) {
          ...
          if (
            ...
            r.length > 1 &&
              '0' == r.charAt(0) &&
              ((o = So.test(r) ? 16 : 8), (r = r.slice(8 == o ? 1 : 2))),
            '' === r)
          )
            a = 0;
          else {
      ...
      qo = { ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443 },
      Ho = function (e) {
            ...
            case Go:
              if (o && (ko.test(o) || '+' == o || '-' == o || '.' == o))
                ...
                (h = ''),
                  'file' == e.scheme
                    ? (c = sa)
                    : Ho(e) && i && i.scheme == e.scheme
                    ? (c = Qo)
                    : Ho(e)
                    ? (c = ta)
                    : '/' == r[u + 1]
                    ? ((c = Jo), u++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(''), (c = fa));
              }
              break;
            case Xo:
            ...
            case sa:
              if (((e.scheme = 'file'), '/' == o || '\\' == o)) c = la;
                ...
                if (o == ao)
                  ...
                  if ('#' != o) {
                    Wo(r.slice(u).join('')) ||
                      ((e.host = i.host), (e.path = i.path.slice()), Ko(e)),
                      (c = ha);
                    continue;
                  }
                  (e.host = i.host),
    ...
    if (
      ...
      La &&
        te(ga, 'createObjectURL', function (e) {
          return La.apply(co, arguments);
        }),
        ja &&
          te(ga, 'revokeObjectURL', function (e) {
    ...
    it(ga, 'URL'),
      Le({ global: !0, forced: !dr, sham: !o }, { URL: ga }),
      (function (e) {
        var t = (function () {
            try {
    ...
    Le(
      { target: 'Array', proto: !0, forced: !Ya || !Ga },
      {
        concat: function (e) {
          var t,
            n,
    ...
    var Qa = ut.filter,
      ...
      Za = Zt('filter');
    Le(
      { target: 'Array', proto: !0, forced: !Ja || !Za },
      {
        filter: function (e) {
    ...
    ts in [] &&
      ...
      Le(
        { target: 'Array', proto: !0, forced: ns || !is },
        {
          find: function (e) {
    ...
    Le({ target: 'Array', stat: !0, forced: cs }, { from: Ar });
    var us = pe.includes,
      hs = Zt('indexOf', { ACCESSORS: !0, 1: 0 });
    Le(
    ...
    var fs = ut.map,
      ...
      ps = Zt('map');
    Le(
      { target: 'Array', proto: !0, forced: !ds || !ps },
      {
        map: function (e) {
    ...
    var ms = function (e, t, n) {
      ...
      ks = { start: ws(1), end: ws(2), trim: ws(3) },
      Ts = be.f,
      Ss = A.f,
      Es = x.f,
      As = ks.trim,
    ...
    Le(
      { target: 'String', proto: !0, forced: !Ds('includes') },
      {
        includes: function (e) {
    ...
    var Js = {
        getConstructor: function (e, t, n, i) {
          var r = e(function (e, o) {
              pr(e, r, t),
                zs(e, { type: t, id: Ys++, frozen: void 0 }),
                null != o && Bs(o, e[i], { that: e, AS_ENTRIES: n });
            }),
            o = Ws(t),
            a = function (e, t, n) {
              var i = o(e),
              ...
              if (
                ...
                v ||
                  (((u = t(function (t, n) {
                    ...
                    var i = ms(new l(), t, u);
                    return (
                      null != n && Bs(n, i[s], { that: i, AS_ENTRIES: o }), i
                    );
                  })).prototype = c),
                  (c.constructor = u)),
                  (m || y) && (f('delete'), f('has'), o && f('get')),
                  (y || p) && f(s),
                  a && c.clear && delete c.clear;
              }
              return (
                (h[e] = u),
                Le({ global: !0, forced: u != l }, h),
                it(u, e),
                a || n.setStrong(u, e, o),
                u
              );
      ...
      tl = Zt('every');
    Le(
      { target: 'Array', proto: !0, forced: !el || !tl },
      {
        every: function (e) {
      ...
      Le(
        { target: 'Object', stat: !0, forced: Object.assign !== vr },
        { assign: vr }
      );
    var nl = ks.trim;
    Le(
    ...
    var il = ut.some,
      ...
      ol = Zt('some');
    Le(
      { target: 'Array', proto: !0, forced: !rl || !ol },
      {
        some: function (e) {
    ...
    Le(
      { target: 'Object', stat: !0, forced: !o || vl, sham: !o },
      {
      ...
      Le(
        { target: 'Object', stat: !0, sham: !o },
        {
          getOwnPropertyDescriptors: function (e) {
            for (
              var t, n, i = m(e), r = A.f, o = ke(i), a = {}, s = 0;
              o.length > s;
    ...
    var El = function (e) {
      ...
      _l = function (e) {
        return (
          Cl(e) ||
          ((xl(e) || Ol(e) || Il(e)) && !e.length) ||
          (Pl(e) && !Object.keys(e).length)
        );
      };
    function Ul(e, t) {
      if (1 > t) {
      ...
      Hl = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            Rl(t)
              ? (this.element = t)
              : Ll(t) && (this.element = document.querySelector(t)),
            Rl(this.element) &&
              _l(this.element.rangeTouch) &&
              ((this.config = kl({}, Tl, {}, n)), this.init());
        }
        return (
          (function (e, t, n) {
    ...
    (Yl && Gl) ||
      ...
      Kl
        ...
        : i.addEventListener &&
          ...
          'file:' !== $l.protocol &&
          !r(oc)
        ? ((Dl = oc), i.addEventListener('message', rc, !1))
        : (Dl =
            tc in T('script')
              ? function (e) {
    ...
    Tc ||
      ...
      !Wl && !Kl && vc && yc
        ? ((uc = !0),
          ...
          new vc(ac).observe(hc, { characterData: !0 }),
          (cc = function () {
            hc.data = uc = !uc;
          }))
        : wc && wc.resolve
        ? ((fc = wc.resolve(void 0)),
          (dc = fc.then),
          (cc = function () {
            dc.call(fc, ac);
          }))
    ...
    var Sc,
      ...
      Yc = Oe(Rc, function () {
        ...
        return (
          ((e.constructor = {})[Nc] = t), !(e.then(function () {}) instanceof t)
        );
      }),
      Gc =
        Yc ||
        ...
        if (!e.notified) {
          ...
          Pc(function () {
            for (var i = e.value, r = 1 == e.state, o = 0; n.length > o; ) {
              ...
              try {
                u
                  ? (r || (2 === e.rejection && tu(e), (e.rejection = 1)),
                    !0 === u
                      ? (a = i)
                      : (d && d.enter(), (a = u(i)), d && (d.exit(), (l = !0))),
                    a === c.promise
                      ? f(Fc('Promise-chain cycle'))
                      : (s = Xc(a))
                      ? s.call(a, h, f)
                      : h(a))
                  : f(i);
      ...
      Jc = function (e, t, n) {
        var r, o;
        Wc
          ? (((r = qc.createEvent('Event')).promise = t),
            (r.reason = n),
            r.initEvent(e, !1, !0),
            i.dispatchEvent(r))
      ...
      tu = function (e) {
        jc.call(i, function () {
          var t = e.facade;
          Kl
            ? Hc.emit('rejectionHandled', t)
            : Jc('rejectionhandled', t, e.value);
        });
      },
      nu = function (e, t, n) {
        return function (i) {
    ...
    Yc &&
      ...
      Le({ global: !0, wrap: !0, forced: Yc }, { Promise: Dc }),
      it(Dc, Rc, !1),
      zl(Rc),
      (Ac = re(Rc)),
      Le(
        { target: Rc, stat: !0, forced: Yc },
        {
          reject: function (e) {
            var t = Vc(this);
    ...
    var ou,
      ...
      cu = Ds('startsWith'),
      uu = !(
        cu || ((ou = au(String.prototype, 'startsWith')), !ou || ou.writable)
      );
    Le(
      { target: 'String', proto: !0, forced: !uu && !cu },
      {
        startsWith: function (e) {
          var t = String(p(this));
          _s(e);
          var n = ce(
              lu(arguments.length > 1 ? arguments[1] : void 0, t.length)
            ),
            i = String(e);
    ...
    var hu,
      ...
      Tu = function (e) {
        return (
          gu(e) ||
          ((yu(e) || wu(e) || ku(e)) && !e.length) ||
          (vu(e) && !Object.keys(e).length)
        );
      },
      Su = gu,
      Eu = vu,
      ...
      Uu = Tu,
      Du =
        ((hu = document.createElement('span')),
        (fu = {
    ...
    function Ku() {
      ...
      return Eu(r)
        ? (Object.keys(r).forEach(function (t) {
            Eu(r[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, Ua({}, t, {})),
                Ku(e[t], r[t]))
              : Object.assign(e, Ua({}, t, r[t]));
          }),
          Ku.apply(void 0, [e].concat(n)))
        : e;
    }
    function $u(e, t) {
      var n = e.length ? e : [e];
    ...
    function Qu(e) {
      Iu(e) || Ou(e)
        ? Array.from(e).forEach(Qu)
        : Lu(e) && Lu(e.parentNode) && e.parentNode.removeChild(e);
    }
    function Ju(e) {
      if (Lu(e))
    ...
    function Zu(e, t) {
      return Lu(t) && Lu(t.parentNode) && Lu(e)
    ...
    var lh,
      ...
      uh = {
        ...
        pip: !(
          qu.isIPhone ||
          (!xu(Gu('video').webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              Gu('video').disablePictureInPicture))
        ),
        ...
        rangeInput:
          ((lh = document.createElement('input')),
          (lh.type = 'range'),
          'range' === lh.type),
    ...
    function yh() {
      ...
      return new Promise(function (t) {
        return e.ready
          ? setTimeout(t, 0)
          : dh.call(e, e.elements.container, 'ready', t);
      }).then(function () {});
    }
    function bh(e) {
    ...
    function wh(e) {
      return (
        !!(Ou(e) || (Cu(e) && e.includes(':'))) &&
        (Ou(e) ? e : e.split(':')).map(Number).every(Au)
      );
    }
    function kh(e) {
            ...
            Object.defineProperty(e.media, 'quality', {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  ...
                  gh.call(e, e.media, 'qualitychange', !1, { quality: t });
                }
              },
            });
        }
    ...
    if (
      ...
      for (
        var _h = function (e, t) {
            ...
            Rh
              ? r && !o && (e = e.source)
              : e instanceof _h && (o && (t = ui.call(e)), (e = e.source)),
              Mh &&
                (n = !!t && t.indexOf('y') > -1) &&
                (t = t.replace(/y/g, ''));
            var a = ms(Rh ? new Ih(e, t) : Ih(e, t), i ? this : Lh, _h);
            return Mh && n && xh(a, { sticky: n }), a;
          },
          Uh = function (e) {
            (e in _h) ||
              Ch(_h, e, {
    ...
    var nf = {
      getIconUrl: function () {
        var e =
          ...
          (qu.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: e };
      },
      findElements: function () {
        try {
          return (
            (this.elements.controls = ah.call(
              this,
            ...
            (this.elements.progress = ah.call(
              this,
      ...
      createIcon: function (e, t) {
        ...
        Yu(o, Ku(t, { 'aria-hidden': 'true', focusable: 'false' }));
      ...
      createBadge: function (e) {
        if (Uu(e)) return null;
        var t = Gu('span', { class: this.config.classNames.menu.value });
        return (
          t.appendChild(
            Gu('span', { class: this.config.classNames.menu.badge }, e)
          ),
          t
        );
      },
      createButton: function (e, t) {
        ...
        return (
          o.toggle
            ? (a.appendChild(
                nf.createIcon.call(this, o.iconPressed, {
                  class: 'icon--pressed',
                })
              ),
              a.appendChild(
                nf.createIcon.call(this, o.icon, { class: 'icon--not-pressed' })
              ),
              a.appendChild(
                nf.createLabel.call(this, o.labelPressed, {
                  class: 'label--pressed',
                })
              ),
              a.appendChild(
                nf.createLabel.call(this, o.label, {
          ...
          Yu(a, i),
          'play' === r
            ? (Ou(this.elements.buttons[r]) || (this.elements.buttons[r] = []),
      ...
      createRange: function (e, t) {
        var n = Gu(
          'input',
          Ku(
            eh(this.config.selectors.inputs[e]),
            {
              type: 'range',
              min: 0,
              max: 100,
      ...
      createProgress: function (e, t) {
        var n = Gu(
          'progress',
          Ku(
            eh(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
                ...
                32 !== i.which &&
                  (40 === i.which || (o && 39 === i.which)
                    ? ((r = e.nextElementSibling),
                      Lu(r) || (r = e.parentNode.firstElementChild))
      ...
      updateVolume: function () {
        this.supported.ui &&
          (Lu(this.elements.inputs.volume) &&
            nf.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          Lu(this.elements.buttons.mute) &&
            ...
            switch (e.type) {
              ...
              case 'seeked':
                (n = (function (e, t) {
                  ...
                  'timeupdate' === e.type &&
                    nf.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case 'playing':
              case 'progress':
                !(function (e, n) {
      ...
      updateSeekTooltip: function (e) {
        ...
        if (
          ...
          Lu(this.elements.inputs.seek) &&
          Lu(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
      ...
      durationUpdate: function () {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              th(this.elements.display.currentTime, !0),
      ...
      updateSetting: function (e, t, n) {
        ...
        if ((Lu(o) || (o = i && i.querySelector('[role="menu"]')), Lu(o))) {
          ...
          ).innerHTML = nf.getLabel.call(this, e, r);
      ...
      setQualityMenu: function (e) {
        ...
        if (Lu(this.elements.settings.panels.quality)) {
          ...
          Ou(e) &&
            (this.options.quality = Ah(e).filter(function (e) {
              return t.config.quality.options.includes(e);
            }));
          var r = !Uu(this.options.quality) && this.options.quality.length > 1;
          if (
            (nf.toggleMenuButton.call(this, n, r),
            Ju(i),
      ...
      setCaptionsMenu: function () {
        ...
        if (Lu(this.elements.settings.panels.captions)) {
          var t = 'captions',
            ...
            r = Boolean(i.length);
          if (
            (nf.toggleMenuButton.call(this, t, r),
            Ju(n),
            nf.checkMenu.call(this),
            r)
          ) {
            var o = i.map(function (t, i) {
              return {
                ...
                badge:
                  t.language &&
                  nf.createBadge.call(e, t.language.toUpperCase()),
                list: n,
                type: 'language',
              };
            });
      ...
      toggleMenu: function (e) {
        ...
        if (Lu(t) && Lu(n)) {
          ...
          n.setAttribute('aria-expanded', r),
            ...
            r && Nu(e)
              ? nf.focusFirstMenuItem.call(this, null, !0)
              : r || i || sh.call(this, n, Nu(e));
        }
      },
      ...
      create: function (e) {
        ...
        return (
          Ah(Ou(this.config.controls) ? this.config.controls : []).forEach(
            function (s) {
              if (
              ...
              if (
                ('current-time' === s &&
                  u.appendChild(a.call(t, 'currentTime', h)),
                ...
                if (
                  ...
                  p.appendChild(
                    o.call(
                      t,
                      'volume',
                      Ku(m, { id: 'plyr-volume-'.concat(e.id) })
                    )
                  );
                }
              }
              if (
                ...
                var v = Gu('div', {
                  ...
                  y = Gu('div'),
                  b = Gu('div', { id: 'plyr-settings-'.concat(e.id, '-home') }),
                  w = Gu('div', { role: 'menu' });
                b.appendChild(w),
                  y.appendChild(b),
                  ...
                  t.config.settings.forEach(function (i) {
                    var r = Gu(
                      'button',
                      Ku(eh(t.config.selectors.buttons.settings), {
                        type: 'button',
                        class: ''
                    ...
                    var o = Gu('span', null, Kh(i, t.config)),
                      a = Gu('span', { class: t.config.classNames.menu.value });
                    (a.innerHTML = e[i]),
                      o.appendChild(a),
                      r.appendChild(o),
                      w.appendChild(r);
                    ...
                    l.appendChild(
                      Gu('span', { 'aria-hidden': !0 }, Kh(i, t.config))
                    ),
                      l.appendChild(
                        Gu(
                          'span',
                      ...
                      s.appendChild(l),
                      s.appendChild(Gu('div', { role: 'menu' })),
                      y.appendChild(s),
              ...
              if (
                ('pip' === s && uh.pip && u.appendChild(i.call(t, 'pip', h)),
                'airplay' === s &&
                  uh.airplay &&
      ...
      inject: function () {
        ...
        var i = {
          ...
          r = !0;
        xu(this.config.controls) &&
          (this.config.controls = this.config.controls.call(this, i)),
          this.config.controls || (this.config.controls = []),
          Lu(this.config.controls) || Cu(this.config.controls)
            ? (n = this.config.controls)
            : ((n = nf.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
        ...
        if (
          (r &&
            ...
            (n = o)),
          Cu(this.config.selectors.controls.container) &&
            (a = document.querySelector(
              this.config.selectors.controls.container
            )),
          Lu(a) || (a = this.elements.container),
          a[Lu(n) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
            'afterbegin',
            n
          ),
    ...
    var af = {
        setup: function () {
          if (this.supported.ui)
            if (
              !this.isVideo ||
              this.isYouTube ||
              (this.isHTML5 && !uh.textTracks)
            )
              Ou(this.config.controls) &&
                this.config.controls.includes('settings') &&
                this.config.settings.includes('captions') &&
                nf.setCaptionsMenu.call(this);
            else {
              if (
                (Lu(this.elements.captions) ||
                  ((this.elements.captions = Gu(
                    'div',
                    eh(this.config.selectors.captions)
                  )),
                  (function (e, t) {
                    Lu(e) &&
                      Lu(t) &&
              ...
              if (
                (Pu(i) || (i = this.config.captions.active),
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((s && this.language !== r) || !t.includes(a)) &&
              (af.setLanguage.call(this, r), af.toggle.call(this, i && s)),
            nh(
        ...
        getLabel: function (e) {
          ...
          return (
            !Ru(t) &&
              ...
              (t = af.getCurrentTrack.call(this)),
            Ru(t)
              ? Uu(t.label)
                ? Uu(t.language)
                  ? Kh('enabled', this.config)
                  : e.language.toUpperCase()
                : t.label
              : Kh('disabled', this.config)
          );
        },
      ...
      cf = 'inline',
      uf = { html5: 'html5', youtube: 'youtube', vimeo: 'vimeo' },
      hf = 'audio',
      ff = 'video';
    var df = function () {},
      pf = (function () {
          ...
          _a(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.enabled &&
                    (qu.isIos && this.player.config.fullscreen.iosNative
              ...
              },
              {
                ...
                value: function () {
                  console.log('toggle');
                  this.active ? this.exit() : console.log('enter');
                },
              },
              {
                key: 'usingNative',
              ...
              },
              {
                key: 'target',
                get: function () {
                  return qu.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                    : this.player.elements.fullscreen ||
                        this.player.elements.container;
                },
                ...
                get: function () {
                  ...
                  return (
                    ['webkit', 'moz', 'ms'].some(function (t) {
                      return (
                        !(
                          !xu(document[''.concat(t, 'ExitFullscreen')]) &&
                          !xu(document[''.concat(t, 'CancelFullScreen')])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
    ...
    var yf = {
        ...
        build: function () {
          ...
          Lu(this.elements.controls) ||
            (nf.inject.call(this), this.listeners.controls()),
            ...
            nh(
              ...
              uh.pip && this.isHTML5 && this.isVideo
            ),
            nh(
              this.elements.container,
              this.config.classNames.airplay.supported,
              uh.airplay && this.isHTML5
            ),
            ...
            this.poster &&
              yf.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && nf.durationUpdate.call(this);
        },
        setTitle: function () {
          var e = Kh('play', this.config);
          if (
            (Cu(this.config.title) &&
              !Uu(this.config.title) &&
          ...
          nh(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  'aria-label',
                  Kh(t.playing ? 'pause' : 'play', t.config)
                );
            }),
        ...
        migrateStyles: function () {
          var e = this;
          Object.values(Fa({}, this.media.style))
            .filter(function (e) {
          ...
          _a(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                t.config.keyboard.global &&
                  fh.call(t, window, 'keydown keyup', this.handleKey, e, !1),
            ...
            },
            {
              ...
              value: function () {
                ...
                !t.keyboard.global &&
                  t.keyboard.focused &&
                  dh.call(e, n.container, 'keydown keyup', this.handleKey, !1),
                  dh.call(
                    e,
                    n.container,
                  ...
                  function (t) {
                    ...
                    if (
                      ...
                      !(function (t, n, i) {
                        ...
                        s ||
                          (l
                            ? dh.call(e, window, 'resize', o)
                            : ph.call(e, window, 'resize', o));
                    }
                  }
                );
              },
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  n = t.elements;
                if (
                  (dh.call(t, t.media, 'timeupdate seeking seeked', function (
                    e
                  ) {
            ...
            },
            {
              ...
              value: function () {
                      ...
                      [13, 32].includes(n) &&
                        (13 !== n
                          ? (e.preventDefault(),
                            e.stopPropagation(),
                            nf.toggleMenu.call(t, e))
                          : nf.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
                  ...
                  this.bind(
                    ...
                    function (e) {
                      ...
                      if (!Nu(e) || 39 === i || 37 === i) {
                        ...
                        o && a
                          ? (n.removeAttribute(r), bh(t.play()))
                          : !a &&
                            t.playing &&
                            (n.setAttribute(r, ''), t.pause());
                      }
                    }
                  ),
                  qu.isIos)
                ...
                this.bind(
                  ...
                  qu.isWebkit &&
                    Array.from(oh.call(t, 'input[type="range"]')).forEach(
                      function (n) {
      ...
      wf = Jn('splice'),
      kf = Zt('splice', { ACCESSORS: !0, 0: 0, 1: 2 }),
      Tf = Math.max,
      Sf = Math.min,
      Ef = 9007199254740991,
      Af = 'Maximum allowed length exceeded';
    Le(
      { target: 'Array', proto: !0, forced: !wf || !kf },
      {
        splice: function (e, t) {
          var n,
            i,
        ...
        function c(e, n, i) {
          ...
          function c(t, n) {
            l(
              e,
              function (e) {
                a(s, e), t && a({ success: t, error: n }, e), o(r, e);
              },
              s
            );
          }
    ...
    var Of = {
      ...
      ready: function () {
        ...
        i && Object.assign(o, { controls: !1, sidedock: !1 });
        var a = of(
            Fa(
              {
        ...
        if (
          ...
          u.setAttribute('data-poster', t.poster), (t.media = Zu(u, t.media));
        else {
          var f = Gu('div', {
        ...
        n.customControls ||
          Yh(qh(t.config.urls.vimeo.api, h)).then(function (e) {
            !Uu(e) &&
              e.thumbnail_url &&
              yf.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }),
        ...
        Object.defineProperty(t.media, 'loop', {
          ...
          t.embed.on('loaded', function () {
            ...
            Lu(t.embed.element) && t.supported.ui) &&
          ...
          t.embed.on('progress', function (e) {
            (t.media.buffered = e.percent),
              ...
              1 === parseInt(e.percent, 10) &&
                gh.call(t, t.media, 'canplaythrough'),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
    ...
    var jf = {
        setup: function () {
          var e = this;
          if (
            (nh(this.elements.wrapper, this.config.classNames.embed, !0),
        ...
        getTitle: function (e) {
          var t = this;
          Yh(qh(this.config.urls.youtube.api, e))
            .then(function (e) {
              if (Eu(e)) {
                var n = e.title,
                  i = e.height,
              ...
              events: {
                ...
                onStateChange: function (n) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(n.data) &&
                      ((e.media.seeking = !1), gh.call(e, e.media, 'seeked')),
                    n.data)
                  ) {
                    case -1:
                      gh.call(e, e.media, 'timeupdate'),
          ...
          this.media
            ? (nh(
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? jf.setup.call(this)
                : this.isVimeo && Of.setup.call(this))
        ...
        return (
          _a(e, [
              ...
              value: function () {
                ...
                this.enabled &&
                  (Eu(window.google) && Eu(window.google.ima)
                    ? this.ready()
                    : Pf(this.player.config.urls.googleIMA.sdk)
                        .then(function () {
                          e.ready();
                        })
                        .catch(function () {
              ...
              value: function () {
                ...
                var n = function () {
                  var t = tf(Math.max(e.manager.getRemainingTime(), 0)),
                    n = ''
                      .concat(Kh('advertisement', e.player.config), ' - ')
                      .concat(t);
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  Ou(this.events[e]) || (this.events[e] = []),
    ...
    _f in [] &&
      ...
      Le(
        { target: 'Array', proto: !0, forced: Uf || !Df },
        {
        ...
        Hf || !Bf || !Vf
          ? function (e) {
              ...
              var t = m(this),
                ...
                i = n - 1;
              for (
                arguments.length > 1 && (i = Ff(i, se(arguments[1]))),
                  i < 0 && (i = n + i);
                i >= 0;
                i--
              )
          ...
          : qf;
    Le(
      { target: 'Array', proto: !0, forced: zf !== [].lastIndexOf },
      { lastIndexOf: zf }
    );
    var Wf = function (e, t) {
        var n = {};
        ...
        return (
          _a(e, [
            ...
            },
            {
              key: 'startScrubbing',
              value: function (e) {
                (Su(e.button) || !1 === e.button || 0 === e.button) &&
                  ((this.mouseDown = !0),
                  this.player.media.duration &&
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.elements.thumb.time = Gu('span', {}, '00:00')),
                  ...
                  Lu(this.player.elements.progress) &&
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    t.isHTML5 &&
                      ...
                      $f.insertElements.call(t, 'track', e.tracks),
                    (t.isHTML5 || (t.isEmbed && !t.supported.ui)) &&
                      yf.build.call(t),
                    t.isHTML5 && t.media.load(),
                    Uu(e.previewThumbnails) ||
                      (Object.assign(
              ...
              if (uh.check().api) {
                ...
                switch (o) {
                  case 'div':
                    ...
                    if (
                      Uu(this.provider) ||
                      !Object.keys(uf).includes(this.provider)
                    )
                ...
                (this.supported = uh.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      Lu(this.elements.container) ||
                        ((this.elements.container = Gu('div', { tabindex: 0 })),
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new Kf(this)))
          ...
          _a(
            ...
            [
              ...
              },
              {
                key: 'pause',
                value: function () {
                  return this.playing && xu(this.media.pause)
                    ? this.media.pause()
                    : null;
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.isHTML5
                    ...
                    : xu(this.media.stop) && this.media.stop();
                },
              },
              {
                key: 'restart',
                  ...
                  if (this.supported.ui && !this.isAudio) {
                    ...
                    if (
                      (i &&
                        Ou(this.config.controls) &&
                        this.config.controls.includes('settings') &&
                        !Uu(this.config.settings) &&
                        nf.toggleMenu.call(this, !1),
                      i !== t)
                    ) {
                ...
                value: function (e) {
                  ...
                  if (this.ready) {
                    ...
                    this.stop(),
                      ...
                      this.isHTML5
                        ? (yf.toggleNativeControls.call(this, !0), i())
                        : this.isYouTube
                        ? (clearInterval(this.timers.buffering),
                          clearInterval(this.timers.playing),
                          null !== this.embed &&
                            xu(this.embed.destroy) &&
                            this.embed.destroy(),
                          i())
                        : this.isVimeo &&
              ...
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.min.apply(Math, Ba(this.options.speed))
                    : this.isVimeo
                    ? 0.5
                    : 0.0625;
                },
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.max.apply(Math, Ba(this.options.speed))
                    : this.isVimeo
                    ? 2
                    : 16;
                },
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? yf.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? Cu(e) && wh(e)
                      ? ((this.config.ratio = e), Sh.call(this))
                      : this.debug.error(
              ...
              },
              {
                ...
                set: function (e) {
                  if (uh.pip) {
                    ...
                    xu(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? lf : cf),
                      xu(this.media.requestPictureInPicture) &&
                        (!this.pip && t
                ...
                get: function () {
                  return uh.pip
                    ? Uu(this.media.webkitPresentationMode)
                      ? this.media === document.pictureInPictureElement
                      : this.media.webkitPresentationMode === lf
                    : null;
                },
              },
            ],
